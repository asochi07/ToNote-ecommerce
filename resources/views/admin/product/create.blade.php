    ...
    <div class="container">
        <div class="row">
            <div class="card">
                    ...
                    <div class="card-body">
                        <form  method="POST" action="{{ url('insert-product') }}" class="appointment bg-white" enctype="multipart/form-data">
                            @method('POST')
                            <div id="feedback"></div>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" class="form-control" placeholder="Enter product name" id="name" name="name" value="{{old('name')}}"  required/>
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Slug</label>
                                        <input type="text" class="form-control" placeholder="Re-enter product name..." id="slug" name="slug" value="{{old('slug')}}"  required/>
                                        @if ($errors->has('slug'))
                                            <div class="error" style="color:red;">
                                                {{ $errors->first('slug') }}
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="2" placeholder="Enter small description"  id="small_description" name="small_description" value="{{old('small_description')}}" ></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Description</label>
                                        <textarea class="form-control" rows="5" placeholder="Enter full description" id="description" name="description" value="{{old('description')}}" ></textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="3" class="form-control" placeholder="" id="meta_description" name="meta_description"  required>{{old('meta_description')}}</textarea>
