        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                    <h3 class="font-weight-semi-bold">{{ $product->name}}
                        ...
                        <label class="font-weight-semi-bold float-end badge badge-success rounded">{{ $product->trending == '1' ? 'Trending' : ''}}</label>
                        @endif
                    </h3>
                
                <hr>
                <div class="col-md-6">
                    <span class="font-weight-semi-bold float-start mb-4 badge badge-success p-2 rounded">{{'₦' . number_format($product->selling_price)}}</span>
                    <span class="float-end mb-4 badge badge-danger p-2 rounded"><s>{{'₦' . number_format($product->original_price)}}</s></span><br>
                </div>
                <hr>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    @if ($product->status == '0')
                        <button class="font-weight-semi-bold float-start btn btn-success px-3">In Stock</button>
                    @endif
                </div>
